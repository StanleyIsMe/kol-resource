...
var ProductTableColumns = struct {
	...
	UpdatedAdminID: "product.updated_admin_id",
...
var ProductWhere = struct {
	...
	UpdatedAdminID: whereHelperstring{field: "\"product\".\"updated_admin_id\""},
	CreatedAt:      whereHelpertime_Time{field: "\"product\".\"created_at\""},
	UpdatedAt:      whereHelpertime_Time{field: "\"product\".\"updated_at\""},
	DeletedAt:      whereHelpernull_Time{field: "\"product\".\"deleted_at\""},
}
...
var (
	productAllColumns            = []string{"id", "name", "description", "updated_admin_id", "created_at", "updated_at", "deleted_at"}
	productColumnsWithoutDefault = []string{"name", "description", "updated_admin_id"}
	productColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at"}
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(productPrimaryKeyColumns) == 0 {
				return errors.New("model: unable to upsert product, could not build conflict column list")
			}
